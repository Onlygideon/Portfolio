...
import agromartThumbnail from "./../images/agromart.jpg";
...
const agromartTitle = `AgroMart`;

const agromartLink = "https://agro-mart.netlify.app";
    ...
    <div className={classes.projects} id="projects">
      ...
      <div className={classes.ProjectContent}>
        <div className={classes.paragraph}>
          <p>Below are some of my frontend projects.</p>
        </div>
