...
import frontendThumbnail from "./../images/agromart.jpg";
import uiDesignThumbnail from "./../images/EyeHut.jpg";
    ...
    <div className={classes.projects} id="projects">
      ...
      <div ref={ref} className={classes.ProjectContent}>
        <div className={classes.paragraph}>
          <p>Below are different categories of my personal projects.</p>
        </div>

        <motion.div className={classes.project} animate={anime}>
